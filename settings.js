...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "malvin~l6EihbiS#k6pTomwnftsNjJ_uo2y9gR8KD1ozjaogc7xq2bvccn8",
...
OWNER_NAME: process.env.OWNER_NAME || "Sana X",
// add bot owner name

              DESCRIPTION: process.env.DESCRIPTION || "*© ᴘᴏᴡᴇʀᴇᴅ ʙʏ Sana X*",
// add bot owner name    
